...
const ExperienceItem = ({ job, i }) => (
  ...
  >
    ...
    <div style={{
      ...
      gap: 8, alignItems: "baseline", marginBottom: 4
    }}>
      <span style={{
        color: "var(--fg)", fontWeight: 600, fontSize: 16,
    ...
    <div style={{
      ...
      color: "var(--fg-mute)", fontSize: 12, marginBottom: 12,
      fontFamily: "'JetBrains Mono', monospace"
    }}>
    ...
    {job.bullets && (
      <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "grid", gap: 6 }}>
        {job.bullets.map((b, idx) => (
          <li key={idx} style={{
            color: "var(--fg)", fontSize: 13, display: "flex", gap: 10,
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 14 }}>
            {CV.education.map((e, i) => (
              <li key={i} data-testid={`about-edu-${i}`} className="card-term reveal" style={{ animationDelay: `${0.04 * i}s` }}>
                ...
                <div style={{ color: "var(--fg-mute)", fontSize: 12, marginTop: 4, fontFamily: "'JetBrains Mono', monospace" }}>
                  {e.period}
                </div>
              </li>
            ))}
